    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published_at', models.DateTimeField()),
                ('updated_at', models.DateTimeField()),
                ('news_site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.newssite')),
            ],
        ),
        migrations.CreateModel(
            name='Launch',
        ...
        migrations.AddField(
            model_name='base',
            name='news_site',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.newssite'),
        ),
    ]
