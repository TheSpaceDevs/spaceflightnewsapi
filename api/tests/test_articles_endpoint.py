...
class TestArticlesEndpoint:
    ...
    def test_get_all_articles_with_events(
        self, client: Client, articles: list[Article]
    ) -> None:
    ...
    def test_get_articles_with_launch(
        self, client: Client, articles: list[Article], launches: list[Launch]
    ) -> None:
    ...
    def test_get_articles_with_event(
        self, client: Client, articles: list[Article], events: list[Event]
    ) -> None:
        article_with_event = [
    ...
    def test_get_articles_with_ordering(
        self, client: Client, articles: list[Article]
    ) -> None:
        sorted_data = sorted(
    ...
    def test_get_article_search_articles(
        self, client: Client, articles: list[Article]
    ) -> None:
    ...
    def test_get_articles_search_summary(
        self, client: Client, articles: list[Article]
    ) -> None:
        response = client.get("/v4/articles/?search=title")
        assert response.status_code == 200
    ...
    def test_get_articles_title_contains(
        self, client: Client, articles: list[Article]
    ) -> None:
    ...
    def test_get_articles_title_contains_one(
        self, client: Client, articles: list[Article]
    ) -> None:
    ...
    def test_get_articles_title_contains_all(
        self, client: Client, articles: list[Article]
    ) -> None:
    ...
    def test_get_articles_summary_contains(
        self, client: Client, articles: list[Article]
    ) -> None:
    ...
    def test_get_articles_summary_contains_one(
        self, client: Client, articles: list[Article]
    ) -> None:
    ...
    def test_get_articles_summary_contains_all(
        self, client: Client, articles: list[Article]
    ) -> None:
        response = client.get(
